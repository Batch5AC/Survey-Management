...
import javax.persistence.Table;
	...
	public class AdminDataEntity {
		...
		public String toString() {
			return "AdminDataEntity [inputid=" + inputid + ", userid=" + userid + ", question1=" + question1 + ", question2=" + question2 + ", question3=" + question3
		...
		public AdminDataEntity(int inputid, int userid, int question1, int question2, int question3, int question4,
