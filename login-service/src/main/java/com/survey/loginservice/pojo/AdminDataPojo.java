...
public class AdminDataPojo {
	...
	public AdminDataPojo(int inputid, int userid, int question1, int question2, int question3, int question4,
	...
	public String toString() {
		return "AdminDataPojo [inputid=" + inputid + ", userid=" + userid + ", question1=" + question1 + ", question2="
